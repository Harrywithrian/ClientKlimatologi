...
@Component({
  selector: 'app-menu-utama-pde',
  templateUrl: './menu-utama-pde.component.html',
  styleUrls: ['./menu-utama-pde.component.css'],
})
export class MenuUtamaPdeComponent implements OnInit {
