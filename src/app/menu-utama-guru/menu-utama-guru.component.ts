...
@Component({
  selector: 'app-menu-utama-guru',
  templateUrl: './menu-utama-guru.component.html',
  styleUrls: ['./menu-utama-guru.component.css'],
})
export class MenuUtamaGuruComponent implements OnInit {
