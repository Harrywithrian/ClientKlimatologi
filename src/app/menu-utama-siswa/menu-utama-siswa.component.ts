...
@Component({
  selector: 'app-menu-utama-siswa',
  templateUrl: './menu-utama-siswa.component.html',
  styleUrls: ['./menu-utama-siswa.component.css'],
})
export class MenuUtamaSiswaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    //redirect to login
    if (localStorage.getItem('nis') == null) {
